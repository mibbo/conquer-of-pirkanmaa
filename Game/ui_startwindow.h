...
public:
    ...
    void retranslateUi(QDialog *StartWindow)
    {
        ...
        versionLabel->setText(QApplication::translate("StartWindow", "git version:", Q_NULLPTR));
        hashLabel->setText(QApplication::translate("StartWindow", "git_commit_hash", Q_NULLPTR));

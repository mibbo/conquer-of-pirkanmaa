...
# Template: subdirs
# Command: /usr/bin/qmake -o Makefile Exercise_project.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
DISTDIR = /home/tommi/sync/git/otek/double-t/.tmp/Exercise_project1.0.0
SUBTARGETS    =  \
...
sub-Course-CourseLib-qmake_all:  FORCE
	...
	cd Course/CourseLib/ && $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd Course/CourseLib/ && $(MAKE) -f Makefile qmake_all
sub-Course-CourseLib: FORCE
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
sub-Course-CourseLib-make_first: FORCE
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile 
sub-Course-CourseLib-all: FORCE
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-Course-CourseLib-clean: FORCE
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-Course-CourseLib-distclean: FORCE
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-Course-CourseLib-install_subtargets: FORCE
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-Course-CourseLib-uninstall_subtargets: FORCE
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall
sub-UnitTests-qmake_all: sub-Game-qmake_all FORCE
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd UnitTests/ && $(MAKE) -f Makefile qmake_all
sub-UnitTests: sub-Game FORCE
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
sub-UnitTests-make_first: sub-Game-make_first FORCE
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile 
sub-UnitTests-all: sub-Game-all FORCE
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-UnitTests-clean: sub-Game-clean FORCE
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-UnitTests-distclean: sub-Game-distclean FORCE
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-UnitTests-install_subtargets: sub-Game-install_subtargets FORCE
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-UnitTests-uninstall_subtargets: sub-Game-uninstall_subtargets FORCE
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall
sub-Game-qmake_all: sub-Course-CourseLib-qmake_all FORCE
	@test -d Game/ || mkdir -p Game/
	cd Game/ && $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
	cd Game/ && $(MAKE) -f Makefile qmake_all
sub-Game: sub-Course-CourseLib FORCE
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile
sub-Game-make_first: sub-Course-CourseLib-make_first FORCE
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile 
sub-Game-all: sub-Course-CourseLib-all FORCE
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile all
sub-Game-clean: sub-Course-CourseLib-clean FORCE
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile clean
sub-Game-distclean: sub-Course-CourseLib-distclean FORCE
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile distclean
sub-Game-install_subtargets: sub-Course-CourseLib-install_subtargets FORCE
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile install
sub-Game-uninstall_subtargets: sub-Course-CourseLib-uninstall_subtargets FORCE
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile uninstall

Makefile: Exercise_project.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
...
sub-Course-CourseLib-check:
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
sub-UnitTests-check: sub-Game-check
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
sub-Game-check: sub-Course-CourseLib-check
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile check
check: sub-Course-CourseLib-check sub-UnitTests-check sub-Game-check

sub-Course-CourseLib-benchmark:
	@test -d Course/CourseLib/ || mkdir -p Course/CourseLib/
	cd Course/CourseLib/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Course/CourseLib/CourseLib.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark
sub-UnitTests-benchmark: sub-Game-benchmark
	@test -d UnitTests/ || mkdir -p UnitTests/
	cd UnitTests/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/UnitTests/UnitTests.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark
sub-Game-benchmark: sub-Course-CourseLib-benchmark
	@test -d Game/ || mkdir -p Game/
	cd Game/ && ( test -e Makefile || $(QMAKE) -o Makefile /home/tommi/sync/git/otek/double-t/Game/Game.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug ) && $(MAKE) -f Makefile benchmark

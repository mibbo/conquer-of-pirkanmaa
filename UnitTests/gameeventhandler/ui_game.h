...
public:
    ...
    void setupUi(QMainWindow *Game)
    {
        ...
        QFont font;
        font.setFamily(QStringLiteral("URW Gothic"));
        ...
        QFont font1;
        font1.setFamily(QStringLiteral("URW Gothic"));
        ...
        QFont font2;
        font2.setFamily(QStringLiteral("URW Gothic"));
        ...
        QFont font3;
        font3.setFamily(QStringLiteral("URW Gothic"));
        ...
        QFont font4;
        font4.setFamily(QStringLiteral("Nimbus Roman"));
    ...
    {
        Game->setWindowTitle(QApplication::translate("Game", "Pirkanmaan Valloitus", Q_NULLPTR));
